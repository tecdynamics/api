...
namespace Tec\Api\Facades;

use Tec\Api\Supports\ApiHelper as ApiHelperSupport;
use Illuminate\Support\Facades\Facade;

/**
 * @method static string modelName()
 * @method static \Tec\Api\Supports\ApiHelper setModelName(string $modelName)
 ...
 *
 * @see \Tec\Api\Supports\ApiHelper
 */
